...
public class DrawingPanel extends FileFilter
     ...
     * } catch (SecurityException e) {
     * if (DEBUG) System.out.println("Security exception when trying to read " +
     * name);
     * return false;
     * }
     * }
    ...
    class Gif89Encoder {
         ...
         * @return
         *         Gif89Frame object at the specified position (or null if no such
         *         frame).
         */
         ...
         *                        if either (1) the
         *                        aggregate cross-frame RGB color count exceeds 256, or
         *                        (2) the Gif89Frame
         *                        subclass is incompatible with the present encoder
         *                        object.
         */
         ...
         *                        cross-frame RGB
         *                        color count exceeds 256, or (3) this encoder object
         ...
         *                        any unchecked
         *                        exceptions that can be thrown when adding an
         *                        IndexGif89Frame
         *                        <i>per se</i>. But I might add some pedantic check
         ...
         *                        If Gif89Frame can't be accommodated. This could happen
         *                        if either (1)
         *                        the aggregate cross-frame RGB color count exceeds 256,
         *                        or (2) the
         *                        Gif89Frame subclass is incompatible with the present
         *                        encoder object.
         */
    ...
    abstract class Gif89Frame {
        ...
        void encode(OutputStream os, boolean epluribus, int color_depth,
            ...
            new GifPixelsEncoder(
                    theWidth, theHeight, ciPixels, isInterlaced, color_depth).encode(os);
        }
