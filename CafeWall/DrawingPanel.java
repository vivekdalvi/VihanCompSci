...
public class DrawingPanel extends FileFilter implements ActionListener, MouseMotionListener, Runnable, WindowListener {
     ...
     * System.out.println("Security exception when trying to read " + name); return
     * false; } }
     */
    ...
    private class DiffImage extends JPanel implements ActionListener, ChangeListener {
        ...
        /*
         * // Displays differences between the two given image files. public void
         * diff(File input1, File input2) throws IOException {
         * diff(ImageIO.read(input1), ImageIO.read(input2)); label1Text =
         * input1.getName(); label2Text = input2.getName(); }
         */
        ...
        // }
        /*
         * // Displays differences between the two given images. public void
         * diff(BufferedImage image1, BufferedImage image2) { if (image1 == null ||
         * image2 == null) { throw new NullPointerException("Null images.\n\t" +
         * "image1: " + image1 + "\n\t" + "image2: " + image2); }
         * 
         * setImage1(image1); setImage2(image2); countDiffPixels(); }
         */
    ...
    class DirectGif89Frame extends Gif89Frame {
         ...
         * @param argb_pixels Array containing at least width*height pixels in the
    ...
    class Gif89Encoder {
        ...
        // ----------------------------------------------------------------------------
        /**
         * This constructor installs a user color table, overriding the detection of of
         * a palette from ARBG pixels.
         *
         * Use of this constructor imposes a couple of restrictions: (1) Frame objects
         * can't be of type DirectGif89Frame (2) Transparency, if desired, must be set
         * explicitly.
         *
         * @param colors Array of color values; no more than 256 colors will be read,
        ...
        // ----------------------------------------------------------------------------
        /**
         * Convenience constructor for encoding a static GIF from index-model data. Adds
         * a single frame as specified.
         *
         * @param colors    Array of color values; no more than 256 colors will be read,
         *                  since that's the limit for a GIF.
        ...
        // ----------------------------------------------------------------------------
        /**
         * Add a Gif89Frame frame to the end of the internal sequence. Note that there
         * are restrictions on the Gif89Frame type: if the encoder object was
         ...
         * @exception IOException If Gif89Frame can't be accommodated. This could happen
         ...
         * @param ci_pixels Array of color-index pixels no less than width * height in
         *                  length.
         * @exception IOException Actually, in the present implementation, there aren't
         ...
         *
         * @param index Index of the color that should be rendered as transparent, if
        ...
        // ----------------------------------------------------------------------------
        /**
         * A convenience method for setting the "animation speed". It simply sets the
         * delay parameter for each frame in the sequence to the supplied value. Since
         * this is actually frame-level rather than animation-level data, take care to
         * add your frames before calling this method.
         *
        ...
        // ----------------------------------------------------------------------------
        /**
         * After adding your frame(s) and setting your options, simply call this method
         * to write the GIF to the passed stream. Multiple calls are permissible if for
         * some reason that is useful to your application. (The method simply encodes
     ...
     * Poskanzer's well-known <cite>Acme GifEncoder</cite>, so please see the
    ...
    abstract class Gif89Frame {
         ...
         * done with this frame's display area before the subsequent frame is displayed.
         * For instance, a setting of DM_BGCOLOR can be used for erasure when redrawing
         * with displacement.
         *
